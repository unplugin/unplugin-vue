...
Thanks to [Vite](https://github.com/vitejs/vite). This project is inherited from [@vitejs/plugin-vue@2.3.1](https://github.com/vitejs/vite/tree/plugin-vue@2.3.1/packages/plugin-vue).
