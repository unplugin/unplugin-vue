...
Thanks to [Vite](https://github.com/vitejs/vite). This project is inherited from [@vitejs/plugin-vue@3.0.0](https://github.com/vitejs/vite/tree/plugin-vue@3.0.0/packages/plugin-vue).
